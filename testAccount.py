#test account
#Subscribes dummy accounts to a database test Account_Management.py
#
#
...
print Account_Management.recieve_answer('+1747629273','hola')
print Account_Management.recieve_answer('+124','10')
